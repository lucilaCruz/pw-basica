                ...
                <tbody>
                    <?php foreach ($listaCategoria as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn-editar" onclick="editarCategoria(<?= $value['idcategoria'] ?>)">
                                    <i class="fa fa-edit"></i>
                                    Editar
                                </button>
                            </td>
                            <td>
                                <button type="button" class="btn-eliminar" onclick="eliminarCategoria(<?= $value['idcategoria'] ?>,'<?= $value['nombre'] ?>')">
